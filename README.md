...
> 
> The models with the old names (with the suffix `V1_X`) are kept in the repository but are **deprecated, not maintained or tested**, they will be removed in the 2026.02 distro release (around the end of Feb 2026), so please update your configuration files/sdf files in order to use the models with the `SN00X` suffix.
